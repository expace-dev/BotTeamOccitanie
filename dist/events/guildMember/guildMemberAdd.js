...
class default_1 extends sheweny_1.Event {
    ...
    async execute(member, guild) {
        ...
        member.roles.add('963732605138784276');
        ...
        Dans un premier temps nous vous demanderons d'accepter notre règlement qui est disponible dans le salon <#963716030406991942>
      `)
            .setColor(`#82a800`)
            .setImage('attachment://profile-image.png');
        const arrivedChannel = this.client.channels.cache.get('963763496129032192');
        // @ts-expect-error
